...
public class TestScenario05_JSExecutor_GenerateAlertInfo {
	...
	public static void main(String[] args) throws IOException, InterruptedException
	{
		...
		JavaScriptUtil.generateAlert(driver, "User clicked on the JoinforFree button...");
		Thread.sleep(5000);
		File src = ((TakesScreenshot) driver).getScreenshotAs(OutputType.FILE);
		File trg = new File("C:\\Users\\admin\\Desktop\\Screenshot\\TestCase05.jpg");
